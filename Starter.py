...
# KHyojin,11.17.2020,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
# Data ---------------------------------------------------------------------- #
...
"""
    ...
    def input_task_to_remove():
        removing = str(input("Remove which task? - "))
        print()
        return removing
# Main Body of Script  ------------------------------------------------------ #
...
while(True):
    ...
    if strChoice.strip() == '1':  # Add a new Task
        ...
        if strStatus == 'Success':
            print('Done!')
        lstTable, status = Processor.add_data_to_list(task, priority, lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu

    elif strChoice == '2':  # Remove an existing Task
        removing = IO.input_task_to_remove()
        if strStatus == 'Success':
            print('Done!')
        task, lstTable = Processor.remove_data_from_list(task, lstTable)
        IO.input_press_to_continue(strStatus)
        continue  # to show the menu
